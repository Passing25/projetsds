...
function rigisterProfile() {
	...
	if (form.gender.value == 'male') {
		imageSrc = 'http://vignette4.wikia.nocookie.net/yogscast/images/f/fd/YOGSCASTRidgedog.png/revision/latest/zoom-crop/width/240/height/240?cb=20131113061509'
	} else {
		imageSrc = 'https://upload.wikimedia.org/wikipedia/commons/0/07/Avatar_girl_face.png'
	}
